...
public:
    ...
    std::vector<Person> curlCard(const std::string &query, const string &label);
    ...
    std::vector<Person> getAllCards(const std::string &label ,const std::string &server, const std::string &query);
