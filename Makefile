...
# Generated by qmake (2.01a) (Qt 4.8.4) on: Tue Feb 12 18:42:46 2013
...
SOURCES       = main.cpp \
		...
		encoding.cpp \
		url.cpp \
		stringutils.cpp qrc_carddavquery.cpp
OBJECTS       = main.o \
		cardcurler.o \
		person.o \
		settings.o \
