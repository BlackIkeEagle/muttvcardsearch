...
# Generated by qmake (2.01a) (Qt 4.8.4) on: Tue Feb 12 21:04:13 2013
# Project:  qvcardsearch.pro
# Template: app
# Command: /usr/bin/qmake -spec /usr/share/qt/mkspecs/linux-g++-64 CONFIG+=debug CONFIG+=declarative_debug -o Makefile qvcardsearch.pro
#############################################################################
...
LIBS          = $(SUBLIBS)  -L/usr/lib -lcurl -lvcard -lsqlite3 -lQtCore -lpthread 
AR            = ar cqs
RANLIB        = 
QMAKE         = /usr/bin/qmake
TAR           = tar -cf
...
SOURCES       = main.cpp \
		...
		url.cpp \
		stringutils.cpp \
		fileutils.cpp qrc_carddavquery.cpp
OBJECTS       = main.o \
		cardcurler.o \
		person.o \
		settings.o \
...
Makefile: qvcardsearch.pro  /usr/share/qt/mkspecs/linux-g++-64/qmake.conf /usr/share/qt/mkspecs/common/unix.conf \
	...
	$(QMAKE) -spec /usr/share/qt/mkspecs/linux-g++-64 CONFIG+=debug CONFIG+=declarative_debug -o Makefile qvcardsearch.pro
...
encoding.o: encoding.cpp encoding.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o encoding.o encoding.cpp

url.o: url.cpp url.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o url.o url.cpp

stringutils.o: stringutils.cpp stringutils.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o stringutils.o stringutils.cpp
