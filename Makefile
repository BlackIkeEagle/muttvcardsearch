...
# Generated by qmake (2.01a) (Qt 4.8.4) on: Do. Jan 10 21:04:18 2013
...
LIBS          = $(SUBLIBS)  -L/usr/lib -lcurl -lpugixml -lvcard -lQtCore -lpthread 
AR            = ar cqs
RANLIB        = 
QMAKE         = /usr/bin/qmake
TAR           = tar -cf
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/qvcardsearch1.0.0/ && $(COPY_FILE) --parents cardcurler.h person.h settings.h option.h .tmp/qvcardsearch1.0.0/ && $(COPY_FILE) --parents carddavquery.qrc .tmp/qvcardsearch1.0.0/ && $(COPY_FILE) --parents main.cpp cardcurler.cpp person.cpp settings.cpp option.cpp .tmp/qvcardsearch1.0.0/ && (cd `dirname .tmp/qvcardsearch1.0.0` && $(TAR) qvcardsearch1.0.0.tar qvcardsearch1.0.0 && $(COMPRESS) qvcardsearch1.0.0.tar) && $(MOVE) `dirname .tmp/qvcardsearch1.0.0`/qvcardsearch1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/qvcardsearch1.0.0
