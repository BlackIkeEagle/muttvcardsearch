...
# Generated by qmake (2.01a) (Qt 4.8.4) on: Sun Feb 10 07:55:20 2013
...
SOURCES       = main.cpp \
		...
		settings.cpp \
		option.cpp \
		cache.cpp qrc_carddavquery.cpp
OBJECTS       = main.o \
		cardcurler.o \
		person.o \
		settings.o \
